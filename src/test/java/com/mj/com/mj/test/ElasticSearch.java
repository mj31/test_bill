...
public class ElasticSearch {
    ...
    Client client = getClient("121.199.20.251");
     ...
     * @return
     */
    public byte[] convertByteArray(Object obj)throws Exception {
    ...
    public void test() throws Exception {
        ...
        User user = new User();
        user.setId(1);
        user.setLoginName("更新第一条");
        user.setDepartment("这是一个测试的数据");
